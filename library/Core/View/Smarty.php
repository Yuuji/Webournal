...
class Core_View_Smarty extends Core_View_View
{
    /**
     * Instance of Smarty
     * @var Smarty
    ...
    protected function _run()
    {
        ...
        if ($this->_customTemplate || $file) {
            ...
            // First default Module then core
            $this->setBasePath(APPLICATION_PATH . '/modules/' . (isset($this->_config['defaultModule']) ? $this->_config['defaultModule'] : 'default') . '/views/');
            $this->addBasePath(Core()->Front()->getModuleDirectory('core').'/views');
            
            Core()->Log($this->_smarty->getTemplateVars());
    ...
    public function setBasePath($path, $classPrefix = 'Zend_View')
    {
        ...
        $this->addBasePath(Core()->Front()->getModuleDirectory('core') . DIRECTORY_SEPARATOR . '/views/');
        $this->setScriptPath($path . '/templates');
        $this->setTemplateDir($path . '/templates/static');
        return $this;
    }
